...
public class PM_Bans
{
    ...
    public static void addBan(OfflinePlayer player, CommandSender sender, String reason, long time) throws SQLException
    {
        ...
        {
            ip = PM_SqlHandler.getIp(player.getName());
        }
    ...
    public static void removeBan(CommandSender sender, OfflinePlayer player) throws SQLException
    {
        ...
        statement.setString(2, PM_SqlHandler.getIp(player.getName()));
        statement.executeUpdate();
    }
    ...
    public static String getReason(OfflinePlayer player) throws SQLException
    {
        ...
        Object obj = PM_SqlHandler.getFromTable("playerName", player.getName(), "banReason", "bans");
        if(obj instanceof String)
        {
            return (String) obj;
        }
        obj = PM_SqlHandler.getFromTable("ip", PM_SqlHandler.getIp(player.getName()), "banReason", "bans");
        if(obj instanceof String)
        {
            return (String) obj;
        }
    ...
    public static String getBanner(OfflinePlayer player) throws SQLException
    {
        ...
        Object obj = PM_SqlHandler.getFromTable("playerName", player.getName(), "senderName", "bans");
        if(obj instanceof String)
        {
            return (String) obj;
        }
        obj = PM_SqlHandler.getFromTable("ip", PM_SqlHandler.getIp(player.getName()), "senderName", "bans");
        if(obj instanceof String)
        {
            return (String) obj;
        }
    ...
    public static boolean isBanned(OfflinePlayer player) throws SQLException
    {
        try
        {
            Long time = 0L;
            Long bantime = 0L;
            Object obj = PM_SqlHandler.getFromTable("playerName", player.getName(), "time", "bans");
            ...
            {
                obj = PM_SqlHandler.getFromTable("ip", PM_SqlHandler.getIp(player.getName()), "time", "bans");
                if(obj instanceof Long)
                {
                    time = (Long) obj;
                }
            }
            obj = PM_SqlHandler.getFromTable("playerName", player.getName(), "banTime", "bans");
            if(obj instanceof Long)
            {
                bantime = (Long) obj;
            }
