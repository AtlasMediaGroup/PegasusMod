...
@CommandParameters(name = "smite", description = "Someone being a pain? Take em' down.", usage = "/smite <playername> <reason>", rank = PM_Rank.Rank.SUPER)
