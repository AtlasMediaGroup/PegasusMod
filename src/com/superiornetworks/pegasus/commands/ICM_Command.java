...
import com.superiornetworks.pegasus.PM_Rank.Rank;
...
public abstract class ICM_Command implements CommandExecutor, TabExecutor
{
    ...
    private void unRegisterBukkitCommand(PluginCommand cmd)
    {
        try
        {
            Object result = getPrivateField(PegasusMod.plugin.getServer().getPluginManager(), "commandMap");
    ...
    public final class ReflectCommand extends Command
    {
        ...
        public boolean execute(CommandSender sender, String commandLabel, String[] args)
        {
            if(exe != null)
            {
                if(!PM_Rank.isEqualOrHigher(PM_Rank.getRank(sender), rank))
                {
