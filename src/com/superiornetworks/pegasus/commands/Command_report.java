...
@CommandParameters(name = "report", description = "Report another player for breaking the rules.", usage = "/report <player> <reason>", rank = PM_Rank.Rank.OP)
public class Command_report
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
    {
        ...
        {
            if(PM_Rank.isRankOrHigher(admin, PM_Rank.Rank.SUPER))
            {
