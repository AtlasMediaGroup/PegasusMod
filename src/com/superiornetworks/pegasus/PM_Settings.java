...
import static com.superiornetworks.pegasus.PM_SqlHandler.getConnection;
...
public class PM_Settings
{
    ...
    {
        return PM_SqlHandler.getFromTable("settingName", settingName, "settingName", "settings") != null;
    }
    ...
    {
        Object obj = PM_SqlHandler.getFromTable("settingName", settingName, "string", "settings");
    ...
    {
        Object obj = PM_SqlHandler.getFromTable("settingName", settingName, "int", "settings");
    ...
    {
        Object obj = PM_SqlHandler.getFromTable("settingName", settingName, "boolean", "settings");
